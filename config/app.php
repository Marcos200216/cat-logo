...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Número de WhatsApp al que se envían las consultas del catálogo (botón
    | de navegación, footer, modal de ayuda y carrito). Se define en el
    | archivo .env como WHATSAPP_URL=https://wa.me/<numero>
    |
    */
